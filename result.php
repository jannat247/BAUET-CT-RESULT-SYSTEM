...
<head>
    ...
    <title>BAUET CT RESULT System</title>
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-12">
                                <h2 class="title" align="center">BAUET CT RESULT System</h2>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><b><?php echo htmlentities($totlcount); ?></b> out of <b><?php echo htmlentities($outof = ($cnt - 1) * 15); ?></b></td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row" colspan="2">Average CT Mark</th>
                                                                <td><b><?php echo  htmlentities($totlcount * (15) / $outof); ?> </b></td>
                                                            </tr
                                                            <tr>
