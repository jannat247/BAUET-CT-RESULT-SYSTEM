...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $dob = $_POST['dob'];
        $status = 1;
        $sql = "INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Password,Gender,ClassId,DOB,Status) VALUES(:studentname,:roolid,:studentemail,:password,:gender,:classid,:dob,:status)";
